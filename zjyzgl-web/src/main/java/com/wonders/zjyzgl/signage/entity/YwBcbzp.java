package com.wonders.zjyzgl.signage.entity;
...
/**
 * The persistent class for the yw_bcbzp database table.
 * 
 */
@Entity
@Table(name="yw_bcbzp")
public class YwBcbzp implements Serializable {
	...
	private BigInteger by01;

	private Timestamp by02;
	...
	public BigInteger getBy01() {
		return this.by01;
	}

	public void setBy01(BigInteger by01) {
		this.by01 = by01;
	}

	public Timestamp getBy02() {
		return this.by02;
	}

	public void setBy02(Timestamp by02) {
		this.by02 = by02;
	}
